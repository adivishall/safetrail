...
| Unit tests | **233 checks across 12 real files, all pass** |
...
```bash
make test        # 233 checks pass — proves it works
...
- **CI on every push:** builds on g++, runs 233 tests (gates the deploy), runs
