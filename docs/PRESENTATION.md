...
| Unit tests | **10,941 checks across 27 real files, all pass** |
...
```bash
make test        # 10,941 checks pass — proves it works
...
- **CI on every push:** builds on g++, runs 10,941 checks (gates the deploy), runs
