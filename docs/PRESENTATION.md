...
| Unit tests | **10,924 checks across 26 real files, all pass** |
...
```bash
make test        # 10,924 checks pass — proves it works
...
- **CI on every push:** builds on g++, runs 10,924 checks (gates the deploy), runs
