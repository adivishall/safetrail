...
| Unit tests | **2,005 checks across 16 real files, all pass** |
...
```bash
make test        # 2,005 checks pass — proves it works
...
- **CI on every push:** builds on g++, runs 2,005 checks (gates the deploy), runs
