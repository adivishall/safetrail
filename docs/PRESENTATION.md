...
| Unit tests | **10,862 checks across 23 real files, all pass** |
...
```bash
make test        # 10,862 checks pass — proves it works
...
- **CI on every push:** builds on g++, runs 10,862 checks (gates the deploy), runs
